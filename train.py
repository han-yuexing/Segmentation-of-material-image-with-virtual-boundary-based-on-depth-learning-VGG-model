...
def train(batch_size, epochs, lr_base, lr_power, weight_decay, classes,
    ...
    def lr_scheduler(epoch, mode='power_decay'):   ###### mode='power_decay'
...
#         ),
    ...
    #model.save(save_path+'/model_c.h5')
...
if __name__ == '__main__':
    ...
    if model_name is 'AtrousFCN_Resnet50_16s':
        ...
        weight_decay = 1e-4
    target_size = (240, 256)  ###############320,320; 115,128; 120,128
    dataset = 'VOC2012_BERKELEY'
    if dataset == 'VOC2012_BERKELEY':
        # pascal voc + berkeley semantic contours annotations
        #train_file_path = os.path.expanduser('/notebooks/FCN_test/data/VOC2011/ImageSets/Segmentation/train.txt') #Data/VOClarge/VOC2012/ImageSets/Segmentation
        train_file_path = os.path.expanduser('data2/trainAvarTxT/train_hd-36.txt') #train.txt ;; trainAvarTxT/train(-16).txt
        #val_file_path   = os.path.expanduser('/notebooks/FCN_test/data/VOC2011/ImageSets/Segmentation/val.txt')
        val_file_path   = os.path.expanduser('trainAvarTxT/val.txt')  #val.txt
        #data_dir        = os.path.expanduser('/notebooks/FCN_test/data/VOC2011/JPEGImages')
        data_dir        = os.path.expanduser('data2/train') #data/train
        #label_dir       = os.path.expanduser('/notebooks/FCN_test/data/VOC2011/SegmentationClass')
        label_dir       = os.path.expanduser('data2/label')  #data/label
        data_suffix='.jpg'
        label_suffix='.png'
        classes = 7  ##########21,6,4,8,6,7
    if dataset == 'COCO':
